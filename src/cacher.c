...
LIBYUC_CONTAINER_HASH_LIST_DEFINE(Cache, PageId, YUDB_CACHER_LRU_LIST_ACCESSOR, LIBYUC_BASIC_ALLOCATOR_DEFALUT, YUDB_CAHCER_LRU_LIST_HASHER, LIBYUC_BASIC_COMPARER_DEFALUT)
