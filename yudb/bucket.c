...
BPlusCursorStatus YuDbBPlusCursorFirst(YuDbBPlusTree* tree, YuDbBPlusCursor* cursor, YuDbKey* key) {
    YuDbBPlusCursorStackVectorInit(&cursor->stack, 32, 0);
...
static _Bool YuDbBPlusTreeInsertElement(YuDbBPlusTree* tree, YuDbBPlusCursor* cursor, YuDbBPlusEntry* src_entry, YuDbBPlusElement* insert_element, int16_t insert_element_id, PageId insert_element_child_id) {
    ...
    do {
        int16_t free_rate = YUDB_BUCKET_BPLUS_ENTRY_ACCESSOR_GetFreeRate(tree, cur);
        int16_t need_rate = YUDB_BUCKET_BPLUS_ELEMENT_ACCESSOR_GetNeedRate(cur, src_entry, insert_element);
        ...
        else if (YUDB_BUCKET_BPLUS_ENTRY_ACCESSOR_GetFreeRate(tree, cur) >= YUDB_BUCKET_BPLUS_ELEMENT_ACCESSOR_GetNeedRate(cur, src_entry, insert_element)) {
